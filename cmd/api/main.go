...
func main() {
	...
	// if true this will just print our version number and exit
	if *displayVersion {
	...
	// publishes the number of active goroutines
	// all values must be JSON encode friendly, else output will be malformed
